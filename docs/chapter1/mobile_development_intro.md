...
| 技术类型            | UI渲染方式      | 性能 | 开发效率 | 动态化     | 框架代表       |开发语言
| ------------------- | --------------- | ---- | -------- | ---------- | -------------- |
| H5+原生             | WebView渲染     | 一般 | 高       | ✔️          | Cordova、Ionic |JavaScript
| JavaScript+原生渲染 | 原生控件渲染    | 好   | 高     | ✔️          | RN、Weex       |JavaScript
| 自绘UI+原生         | 调用系统API渲染 | 好   | Flutter高, QT低       | 默认不支持 | QT、Flutter    |Dart
